...
void calculamediaparacadames(UNICODE *vetor[2019],float media_mes[13],int ano_de_analise);
void movingAverageGlobal( UNICODE *vetor[2019],float *max,float *min,int ano,float minficheiro,int intervalo);
